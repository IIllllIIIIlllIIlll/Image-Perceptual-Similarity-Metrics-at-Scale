...
def DAISY(image, n_features=20):
    ...
    # ORB uses oriented FAST under the hood, .detect in ORB detector does only that first part
...
def LATCH(image, n_features):
    ...
    detector = cv2.ORB_create(nfeatures=n_features)  # Code Reviewer: same thing here
