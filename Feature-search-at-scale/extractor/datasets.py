...
# Code Reviewer: those are configs and are best managed by loading cnf.XXX rather than hard-coded
...
class FlickrDataset(Dataset):
    ...
    def __init__(self, transforms=None):
        ...
        subfolders = [dataset_path + folder + '/' for folder in os.listdir(dataset_path) \
                      if not folder.startswith('.')]  # Code Reviewer: Pathlib is your friend again.
        ...
        # Code Reviewer: Pathlib is your friend, yet again
...
def create_dataset(dataset_name, transforms):
    ...
    elif dataset_name == 'chan_images':
        path = 'Datasets/ChanMemes/icwsm2021-memes-images/filtered/'
