...
class Experiment(object):
    ...
    def set_index(self, factory_str, metric='cosine'):
        ...
        # Code Reviewer: once again, all the self.<XXX> need to be defined in the __init__ part of
        # the code
    ...
    def search_in_batch(self, batch_size=1000):
        ...
        # Code Reviewer:  yeah, those names are not exactly very informative - would you mind renaming?
        self.I = np.zeros((length, self.k), dtype='int64')
        
        N = 0  # Code Reviewer: same thing for informativity of the name
    ...
    def get_neighbors_of_query(self, query_index, target=True):
        ...
        if target:
            ...
            # Code Reviewer: I am not sure why there is a double packing. functions return multiples as tuples
        else:
